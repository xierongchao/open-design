      ...
      import('grapesjs')
        .then((mod) => {
          ...
          const openSpacingInputEditor = (
            ...
            input.style.cssText = 'width:100px;padding:1px 4px;border:1px solid #444;border-radius:4px;background:#000;color:#fff;font:600 12px/1.4 system-ui;text-align:center;outline:none;-moz-appearance:textfield;';
