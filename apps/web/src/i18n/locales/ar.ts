...
export const ar: Dict = {
  ...
  'settings.accountHint': "إدارة حساب 云档期",
  'settings.accountAbout': "الحساب",
  'settings.accountAboutHint': "الإصدار وتسجيل الخروج",
  'settings.accountSignOutTitle': "تسجيل الخروج من 云档期",
  'settings.accountSignOutHint': "مسح بيانات اعتماد التخزين المحلي وإعادة تشغيل التطبيق لإعادة التفويض",
  'settings.accountSignOut': "تسجيل الخروج",
  ...
  'workspace.closeTabsToRight': 'إغلاق علامات التبويب على اليمين',
  'workspace.closeOtherTabs': 'إغلاق علامات التبويب الأخرى',
  'workspace.closeAllTabs': 'إغلاق جميع علامات التبويب',
  ...
  'designFiles.moveLabel': 'مجلد الوجهة',
  ...
  'designFiles.deleteFolderConfirm': 'هل تريد حذف المجلد "{name}" وكل محتوياته؟',
  ...
  'designFiles.newSubfolder': 'مجلد فرعي جديد',
  'designFiles.untitledFolderName': 'مجلد بدون عنوان',
  'designFiles.folderNameEmpty': 'لا يمكن أن يكون اسم المجلد فارغًا.',
  'designFiles.addToFolder': 'إضافة إلى مجلد',
  'designFiles.addToFolderEmpty': 'لا توجد مجلدات بعد',
  'designFiles.selectFolder': 'اختر مجلداً',
  ...
  'designFiles.sectionStylesheets': 'ملفات الأنماط',
  'designFiles.sectionDocuments': 'المستندات',
  'designFiles.kindStylesheet': 'ملف أنماط',
  'designFiles.modifiedExt': 'عُدّل {time} · {size} · {ext}',
  'designFiles.usefulInfoLabel': 'معلومات مفيدة',
  'designFiles.usefulInfoTip': 'انقر نقرًا مزدوجًا على ملف لفتحه في تبويب كامل.',
  'designFiles.batchSelect': 'تحديد دفعي',
...
'designFiles.copyFailed': "فشل النسخ، حاول مرة أخرى",
  ...
  'fileViewer.exportImageScaleLabel': 'المقياس',
  'fileViewer.exportImageSaving': 'جارٍ حفظ الصورة…',
  'fileViewer.exportImageCapturing': 'جارٍ إنشاء المعاينة…',
