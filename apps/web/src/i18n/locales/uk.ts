...
export const uk: Dict = {
  ...
  'settings.accountHint': "Керування обліковим записом 云档期",
  'settings.accountAbout': "Обліковий запис",
  'settings.accountAboutHint': "Версія та вихід",
  'settings.accountSignOutTitle': "Вийти з 云档期",
  'settings.accountSignOutHint': "Очистіть локально збережені облікові дані та перезапустіть застосунок для повторної авторизації",
  'settings.accountSignOut': "Вийти",
  ...
  'workspace.closeAllTabs': 'Закрити всі вкладки',
  ...
  'designFiles.copyPath': 'Копіювати шлях',
  'designFiles.copiedPath': 'Шлях скопійовано',
  'designFiles.deleteFolderConfirm': 'Видалити папку "{name}" і весь її вміст?',
  'designFiles.folderCreated': 'Папку "{name}" створено',
  'designFiles.folderDeleted': 'Папку "{name}" видалено',
  'designFiles.filesMoved': '{n} переміщено до {dest}',
  'designFiles.newSubfolder': 'Нова вкладена папка',
  'designFiles.untitledFolderName': 'Папка без назви',
  'designFiles.folderNameEmpty': 'Назва папки не може бути порожньою.',
  'designFiles.addToFolder': 'Додати до папки',
  'designFiles.addToFolderEmpty': 'Папок ще немає',
  'designFiles.selectFolder': 'Вибрати папку',
  ...
  'designFiles.usefulInfoTip': 'Двічі клацніть файл, щоб відкрити його в повній вкладці.',
  'designFiles.batchSelect': 'Пакетний вибір',
...
'designFiles.copyFailed': "Не вдалося скопіювати, спробуйте ще раз",
  ...
  'fileViewer.exportImageCapturing': 'Створення попереднього перегляду…',
