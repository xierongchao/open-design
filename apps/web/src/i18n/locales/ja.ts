...
export const ja: Dict = {
  ...
  'settings.accountHint': "云档期アカウントを管理",
  'settings.accountAbout': "アカウント",
  'settings.accountAboutHint': "バージョンとサインアウト",
  'settings.accountSignOutTitle': "云档期からサインアウト",
  'settings.accountSignOutHint': "ローカルに保存された認証情報を消去し、アプリを再起動して再認証します",
  'settings.accountSignOut': "サインアウト",
  ...
  'workspace.closeTabsToRight': '右のタブを閉じる',
  'workspace.closeOtherTabs': '他のタブを閉じる',
  'workspace.closeAllTabs': 'すべてのタブを閉じる',
  ...
  'designFiles.newFolderTitle': '新規フォルダ',
  'designFiles.newFolderLabel': 'フォルダ名',
  'designFiles.moveTitle': 'フォルダへ移動',
  'designFiles.moveLabel': '移動先フォルダ',
  'designFiles.moveRoot': 'プロジェクトルート',
  'designFiles.moveNewFolder': '新規フォルダ…',
  'designFiles.move': '移動',
  'designFiles.copyPath': 'パスをコピー',
  'designFiles.copiedPath': 'パスをコピーしました',
  'designFiles.deleteFolderConfirm': 'フォルダ「{name}」とその内容をすべて削除しますか？',
  ...
  'designFiles.newSubfolder': '新規サブフォルダー',
  'designFiles.untitledFolderName': '無題のフォルダー',
  'designFiles.folderNameEmpty': 'フォルダー名は空にできません。',
  'designFiles.addToFolder': 'フォルダーに追加',
  'designFiles.addToFolderEmpty': 'フォルダーがありません',
  'designFiles.selectFolder': 'フォルダを選択',
  ...
  'designFiles.modifiedExt': '更新 {time} · {size} · {ext}',
  'designFiles.usefulInfoLabel': '便利な情報',
  'designFiles.usefulInfoTip': 'ファイルをダブルクリックすると完全なタブで開きます。',
  'designFiles.batchSelect': 'バッチ選択',
...
'designFiles.copyFailed': "コピーに失敗しました。もう一度お試しください",
  ...
  'manualEdit.autoLayout.add': '自動レイアウトを追加',
  'manualEdit.autoLayout.remove': '自動レイアウトを解除',
  'manualEdit.autoLayout.horizontalGap': '横方向の間隔',
  'manualEdit.autoLayout.verticalGap': '縦方向の間隔',
  'manualEdit.autoLayout.horizontalPadding': '左右の余白',
  'manualEdit.autoLayout.verticalPadding': '上下の余白',
  'manualEdit.autoLayout.horizontalDistribution': '横方向に分布',
  'manualEdit.autoLayout.verticalDistribution': '縦方向に分布',
  ...
  'fileViewer.exportImageScaleLabel': 'サイズ',
  'fileViewer.exportImageSaving': '画像を保存中…',
  'fileViewer.exportImageCapturing': 'プレビューを生成中…',
