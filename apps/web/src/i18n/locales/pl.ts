...
export const pl: Dict = {
  ...
  'settings.accountHint': "Zarządzaj kontem 云档期",
  'settings.accountAbout': "Konto",
  'settings.accountAboutHint': "Wersja i wylogowanie",
  'settings.accountSignOutTitle': "Wyloguj się z 云档期",
  'settings.accountSignOutHint': "Wyczyść lokalnie zapisane dane uwierzytelniające i uruchom ponownie aplikację, aby ponownie autoryzować",
  'settings.accountSignOut': "Wyloguj się",
  ...
  'workspace.closeTabsToRight': 'Zamknij karty po prawej',
  'workspace.closeOtherTabs': 'Zamknij inne karty',
  'workspace.closeAllTabs': 'Zamknij wszystkie karty',
  ...
  'designFiles.newSubfolder': 'Nowy podfolder',
  'designFiles.untitledFolderName': 'Folder bez nazwy',
  'designFiles.folderNameEmpty': 'Nazwa folderu nie może być pusta.',
  'designFiles.addToFolder': 'Dodaj do folderu',
  'designFiles.addToFolderEmpty': 'Brak folderów',
  'designFiles.selectFolder': 'Wybierz folder',
  ...
  'designFiles.usefulInfoTip': 'Kliknij plik dwukrotnie, aby otworzyć go w pełnej karcie.',
  'designFiles.batchSelect': 'Wybór wsadowy',
...
'designFiles.copyFailed': "Kopiowanie nie powiodło się, spróbuj ponownie",
  ...
  'fileViewer.exportImageCapturing': 'Generowanie podglądu…',
