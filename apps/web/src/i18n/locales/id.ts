...
export const id: Dict = {
  ...
  'settings.accountHint': "Kelola akun 云档期 Anda",
  'settings.accountAbout': "Akun",
  'settings.accountAboutHint': "Versi dan keluar",
  'settings.accountSignOutTitle': "Keluar dari 云档期",
  'settings.accountSignOutHint': "Hapus kredensial yang disimpan secara lokal dan mulai ulang aplikasi untuk otorisasi ulang",
  'settings.accountSignOut': "Keluar",
  ...
  'workspace.closeTabsToRight': 'Tutup tab di kanan',
  'workspace.closeOtherTabs': 'Tutup tab lain',
  'workspace.closeAllTabs': 'Tutup semua tab',
  ...
  'designFiles.moveTitle': 'Pindah ke folder',
  'designFiles.moveLabel': 'Folder tujuan',
  'designFiles.moveRoot': 'Root proyek',
  'designFiles.moveNewFolder': 'Folder baru…',
  'designFiles.move': 'Pindah',
  'designFiles.copyPath': 'Salin path',
  'designFiles.copiedPath': 'Path disalin',
  'designFiles.deleteFolderConfirm': 'Hapus folder "{name}" beserta semua isinya?',
  'designFiles.folderCreated': 'Folder "{name}" dibuat',
  'designFiles.folderDeleted': 'Folder "{name}" dihapus',
  'designFiles.filesMoved': '{n} dipindahkan ke {dest}',
  'designFiles.newSubfolder': 'Subfolder baru',
  'designFiles.untitledFolderName': 'Folder Tanpa Judul',
  'designFiles.folderNameEmpty': 'Nama folder tidak boleh kosong.',
  'designFiles.addToFolder': 'Tambahkan ke folder',
  'designFiles.addToFolderEmpty': 'Belum ada folder',
  'designFiles.selectFolder': 'Pilih folder',
  ...
  'designFiles.sectionStylesheets': 'Stylesheet',
...
'designFiles.copyFailed': "Gagal menyalin, coba lagi",
  ...
  'manualEdit.height': 'Tinggi',
  'manualEdit.canvasWidth': 'Kanvas L',
  'manualEdit.canvasHeight': 'Kanvas T',
  ...
  'fileViewer.exportImageScaleLabel': 'Skala',
  'fileViewer.exportImageSaving': 'Menyimpan gambar…',
  'fileViewer.exportImageCapturing': 'Membuat pratinjau…',
