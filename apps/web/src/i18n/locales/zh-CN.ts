...
export const zhCN: Dict = {
  ...
  'settings.account': "账户",
  'settings.accountHint': "管理你的云档期账户",
  'settings.accountAbout': "账号",
  'settings.accountAboutHint': "版本信息与退出登录",
  'settings.accountSignOutTitle': "退出云档期登录",
  'settings.accountSignOutHint': "清除本地保存的凭证并重启应用以重新授权",
  ...
  'workspace.closeAllTabs': '关闭所有标签页',
  ...
  'workspace.searchFilesPlaceholder': '搜索文件或标签页',
  'workspace.openTabs': '打开的标签页',
  'workspace.openFile': '打开文件',
  'workspace.noFilesMatch': '没有匹配的文件',
  'workspace.allFiles': '全部文件',
  'workspace.createNew': '新建',
  'workspace.tabOpen': '已打开',
  'workspace.sideChatContextBanner': '侧边对话会将此工作区作为上下文。',
  'workspace.sideChatDefaultTitle': '侧边对话',
  'workspace.newTerminal': '新建终端',
  'workspace.newTerminalDescription': '在此项目中打开 shell',
  'workspace.newBrowser': '新建浏览器',
  'workspace.newBrowserDescription': '打开浏览器标签用于参考',
  'workspace.terminalStarting': '正在启动终端…',
  'workspace.terminalStartingDescription': '正在连接项目 shell。',
  'workspace.terminalSessionEnded': '终端会话已结束。',
  'workspace.terminalReconnecting': '正在重新连接终端…',
  'workspace.terminalStartFailed': '无法启动终端。',
  'workspace.terminalRestart': '重启终端',
  ...
  'designFiles.move': '移动',
  'designFiles.copyPath': '复制路径',
  'designFiles.copiedPath': '已复制路径',
  'designFiles.deleteFolderConfirm': '删除文件夹「{name}」及其中所有内容吗？',
  'designFiles.folderCreated': '已创建文件夹「{name}」',
  'designFiles.folderDeleted': '已删除文件夹「{name}」',
  'designFiles.filesMoved': '已将 {n} 个文件移动到 {dest}',
  'designFiles.newSubfolder': '新建子文件夹',
  'designFiles.untitledFolderName': '未命名文件夹',
    'designFiles.newArtboard': '新增画板',
  'designFiles.artboardCreated': '已创建画板「{name}」',
  'designFiles.exportPdf': '导出 PDF',
  'designFiles.exportImages': '导出图片',
  'designFiles.exportZip': '打包下载',
  'designFiles.imageFormatTitle': '导出图片设置',
  'designFiles.imageFormat': '格式',
  'designFiles.imageScale': '缩放倍率',
  'designFiles.exportBtn': '导出',
  'designFiles.rootNodeMenu': '根目录菜单',
  'designFiles.noHtmlForPdf': '没有可导出的 HTML 文件。',
  'designFiles.noHtmlForImage': '没有可导出的 HTML 文件。',
'designFiles.folderNameEmpty': '文件夹名称不能为空。',
  'designFiles.addToFolder': '添加至文件夹',
  'designFiles.addToFolderEmpty': '暂无文件夹',
  'designFiles.selectFolder': '选择文件夹',
  ...
  'designFiles.usefulInfoLabel': '实用信息',
  'designFiles.usefulInfoTip': '双击文件可在完整标签页中打开。',
  'designFiles.batchSelect': '批量选择',
  'designFiles.expandAll': "全部展开",
  'designFiles.collapseAll': "全部收起",
  'designFiles.copyFailed': "复制失败，请重试",
  ...
  'fileViewer.save': '保存',
  'fileViewer.codeUnsavedConfirm': '代码有未保存的修改，是否放弃修改离开？',
  ...
  'manualEdit.canvasWidth': '画布宽',
  'manualEdit.canvasHeight': '画布高',
  ...
  'manualEdit.section.frame': '画框',
  'manualEdit.section.position': '位置',
  'manualEdit.section.autoLayout': '自动布局',
  'manualEdit.section.appearance': '外观',
  'manualEdit.section.fill': '填充',
  'manualEdit.section.stroke': '描边',
  'manualEdit.section.effect': '效果',
  'manualEdit.section.typography': '排版',
  'manualEdit.section.size': '尺寸',
  'manualEdit.section.margin': '外边距',
  ...
  'manualEdit.autoLayout.grid': '网格',
  'manualEdit.autoLayout.add': '开启自动布局',
  'manualEdit.autoLayout.remove': '关闭自动布局',
  'manualEdit.autoLayout.horizontalGap': '水平间距',
  'manualEdit.autoLayout.verticalGap': '垂直间距',
  'manualEdit.autoLayout.horizontalPadding': '左右边距',
  'manualEdit.autoLayout.verticalPadding': '上下边距',
  'manualEdit.autoLayout.horizontalDistribution': '水平分布式',
  'manualEdit.autoLayout.verticalDistribution': '垂直分布式',
  'manualEdit.label.clipContent': '裁剪内容',
  'manualEdit.label.opacity': '不透明度',
  'manualEdit.label.radius': '圆角',
  'manualEdit.label.strokeWidth': '宽度',
  'manualEdit.label.addShadow': '添加阴影',
  'manualEdit.label.dropShadow': '投影 / 模糊',
  'manualEdit.label.lineHeight': '行高',
  'manualEdit.label.letterSpacing': '字间距',
  'manualEdit.label.expandStroke': '展开描边',
  'manualEdit.label.strokeCenter': '描边居中',
  'manualEdit.label.strokeInside': '描边内侧',
  'manualEdit.label.strokeOutside': '描边外侧',
  'manualEdit.label.strokeSolid': '实线',
  'manualEdit.label.strokeDashed': '虚线',
  'manualEdit.label.dashGap': '虚线间隔',
  'manualEdit.label.collapseSpacing': '收起间距',
  'manualEdit.label.expandSpacing': '展开间距',
  'manualEdit.label.outerMargin': '外间距',
  'manualEdit.label.flexWrap': '换行',
  'manualEdit.label.flexNoWrap': '不换行',
  'manualEdit.hint.clickElement': '点击预览中的元素来编辑其属性。',
  'manualEdit.hint.toggleShortcut': '⌘\\ 切换面板',
  'manualEdit.undoLimitReached': '没有更多的撤销记录。',
  ...
  'fileViewer.interactiveMode': '交互模式',
  'fileViewer.editMode': '编辑模式',
  ...
  'fileViewer.exportImageScaleLabel': '尺寸',
  'fileViewer.exportImageSaving': '正在保存图片…',
  'fileViewer.exportImageCapturing': '正在生成预览…',
  ...
  'common.clear': '清除',
  'settings.onboardingStepNewsletter': '保持关注',
  'settings.onboardingNewsletterTitle': '订阅通讯',
  'settings.onboardingNewsletterBody': '在收件箱中接收技巧、更新和设计灵感。',
  'settings.modelsLoadedCount': '✓ 已加载 {count} 个模型。',
  'settings.byokVideoModel': '视频模型',
  'settings.byokVideoI2vHint': '用于动效生成的图生视频模型。',
  'settings.byokSpeechModel': '语音模型',
  'settings.byokSpeechVoice': '语音',
  'settings.byokModelDefaultOption': '使用默认',
  'settings.designSystemsSourceShadcn': 'shadcn/ui',
  'settings.designSystemsShadcnReference': '从 shadcn/ui 组件库导入组件。',
  'settings.designSystemsImportShadcn': '导入 shadcn/ui',
  'newsletter.label': '通讯（可选）',
  'newsletter.placeholder': 'you@example.com',
  'entry.discordLabel': '加入 Discord',
  'entry.discordAria': '加入 Open Design Discord 社区',
  'entry.discordAriaWithOnline': '加入 Open Design Discord 社区 — {count} 人在线',
  'entry.discordOnlineLabel': '{count} 在线',
  'entry.followXLabel': '在 X 上关注',
  'entry.navExpand': '展开导航',
  'entry.navCollapse': '收起导航',
  'homeHero.templatesScrollHint': '滚动查看更多模板',
  'homeHero.templatesCollapse': '收起模板',
  'homeHero.addMenu': '添加',
  'homeHero.addPlugin': '插件',
  'homeHero.addConnectors': '连接器',
  'homeHero.addMcp': 'MCP 服务器',
  'homeHero.noPlugins': '暂无可用插件',
  'homeHero.noMcp': '暂无可用 MCP 服务器',
  'homeHero.noConnectors': '暂无可用连接器',
  'homeHero.subTypeAria': '副标题选项',
  'handoff.optionsAria': '交接选项',
  'handoff.editorSection': '编辑器交接',
  'handoff.cliSection': 'CLI 交接',
  'handoff.clickOpen': '点击打开',
  'handoff.framework': '框架',
  ...
  'handoff.framework.vanilla': '原生',
  'handoff.frameworkPrompt.react': 'React 组件',
  'handoff.frameworkPrompt.vue': 'Vue 组件',
  'handoff.frameworkPrompt.svelte': 'Svelte 组件',
  'handoff.frameworkPrompt.solid': 'Solid 组件',
  'handoff.frameworkPrompt.next': 'Next.js 页面',
  'handoff.frameworkPrompt.vanilla': '原生 HTML/CSS/JS',
  'handoff.amrWebsite': 'Open Design 网站',
  'handoff.copyPrompt': '复制提示词',
  'handoff.copyPromptForTarget': '为 {target} 复制提示词',
  'handoff.copied': '已复制！',
  'handoff.projectPathUnavailable': '项目路径不可用',
  'handoff.copyFailed': '复制失败',
  'handoff.promptIntro': '你是一位资深前端开发者，正在实现来自 Open Design 的设计稿。',
  'handoff.promptTarget': '目标：生成 {framework}',
  'handoff.promptCli': 'Open Design CLI',
  'handoff.promptStepsLead': '步骤：',
  'handoff.promptReadFiles': '阅读引用的设计文件',
  'handoff.promptKeepDesign': '保持设计意图、布局和视觉还原度',
  'handoff.promptProduceCode': '产出简洁、可发布的代码',
  'handoff.promptVerify': '验证输出与设计一致',
  'handoff.promptCommandHint': '运行：{command}',
  'handoff.promptProject': '项目：{name}',
  'handoff.promptProjectId': '项目 ID：{id}',
  'automations.eyebrow': '计划中的 Agent 会话',
  'automations.title': '自动化',
  'automations.lede': '自动化重复性的设计和开发任务。',
  'automations.summaryAria': '自动化摘要',
  'automations.metricActive': '{count} 个活跃',
  'automations.metricPaused': '{count} 个已暂停',
  'automations.metricTemplates': '{count} 个模板',
  'automations.newAutomation': '新建自动化',
  'automations.yourAutomations': '你的自动化',
  'automations.loading': '加载自动化…',
  'automations.emptyTitle': '暂无自动化',
  'automations.emptyBody': '创建你的第一个自动化，简化重复任务。',
  'automations.targetNewEachRun': '每次运行新目标',
  'automations.lastRun': '上次运行',
  'automations.openResult': '打开结果',
  'automations.run': '运行',
  'automations.runNowTitle': '立即运行',
  'automations.history': '历史记录',
  'automations.hideHistory': '隐藏历史',
  'automations.edit': '编辑',
  'automations.pause': '暂停',
  'automations.resume': '恢复',
  'automations.deleteAria': '删除自动化',
  'automations.deleteTitle': '删除自动化？',
  'automations.deleteConfirm': '此操作无法撤销。',
  'automations.proposalsTitle': '提案',
  'automations.proposalsSub': '近期运行产生的待处理变更。',
  'automations.proposalsPending': '{count} 个待处理',
  'automations.apply': '应用',
  'automations.reject': '拒绝',
  'automations.proposalsDismissReason': '已忽略：{reason}',
  'automations.templatesTitle': '模板',
  'automations.templatesSub': '从预构建的自动化开始。',
  'automations.templatesCount': '{count} 个模板',
  'automations.templateFiltersAria': '模板筛选',
  'automations.templatesEmptyTitle': '没有匹配的模板',
  'automations.templatesEmptyBody': '尝试调整筛选条件。',
  'automations.useTemplate': '使用模板',
  'automations.runHistoryLoading': '加载运行历史…',
  'automations.runHistoryEmpty': '暂无运行记录。',
  'automations.runHistoryTitle': '运行历史',
  'automations.runHistoryLatest': '最新',
  'automations.crystallize': '结晶',
  'automations.crystallizing': '正在结晶…',
  'automations.crystallizeTitle': '结晶对话',
  'automations.openConversation': '打开对话',
  'automations.runHistoryAria': '运行历史',
  'automations.proposalsAria': '提案',
  'automations.templatesAria': '模板',
  'automations.runInProgress': '运行中',
  'automations.scheduleStatusPaused': '已暂停',
  'automations.nextRunManualOnly': '仅手动',
  'automations.nextRunScheduled': '已计划',
  'automations.nextRunAt': '下次：{date}',
  ...
  'automations.kindLiveArtifact': '实时工件',
  'automations.kindAutomation': '自动化',
  'automations.proposalTargetMemory': '记忆',
  'automations.proposalTargetDesignSystem': '设计系统',
  'automations.proposalTargetSkill': '技能',
  'automations.proposalTargetTemplate': '模板',
  ...
  'automations.filterLiveArtifacts': '实时工件',
  'automations.filterMemory': '记忆',
  'automations.filterDesignSystems': '设计系统',
  ...
  'automations.tpl.memoryRefresh.title': '记忆刷新',
  'automations.tpl.memoryRefresh.desc': '定期刷新项目记忆索引。',
  'automations.tpl.designSystemRefresh.title': '设计系统刷新',
  'automations.tpl.designSystemRefresh.desc': '同步设计令牌和组件定义。',
  'automations.tpl.liveArtifactRegistry.title': '实时工件注册表',
  'automations.tpl.liveArtifactRegistry.desc': '维护实时设计工件注册表。',
  'automations.tpl.orbitDashboard.title': 'Orbit 仪表盘',
  'automations.tpl.orbitDashboard.desc': '生成 Orbit 风格的项目仪表盘。',
  'automations.tpl.releaseNotes.title': '发布说明',
  'automations.tpl.releaseNotes.desc': '从近期提交起草发布说明。',
  'automations.tpl.qualityRegressionWatch.title': '质量回归监控',
  'automations.tpl.qualityRegressionWatch.desc': '随时间监控代码质量指标。',
  'automations.tpl.orbitDaily.title': 'Orbit 每日摘要',
  'automations.tpl.orbitDaily.desc': '生成每日项目活动摘要。',
  'automations.tpl.liveStatusBoard.title': '实时状态看板',
  'automations.tpl.liveStatusBoard.desc': '发布实时项目状态页面。',
  'dsManager.areaAria': '设计系统区域',
  'dsManager.tabDesignSystem': '设计系统',
  'dsManager.tabTemplate': '模板',
  'dsManager.sourceAria': '设计系统来源',
  'dsManager.templateSourceAria': '模板来源',
  'dsManager.yourSystems': '你的系统',
  'dsManager.officialPresets': '官方预设',
  'dsManager.enterprise': '企业版',
  'dsManager.yourTemplates': '你的模板',
  'dsManager.yourSystemsAria': '你的设计系统',
  'dsManager.eyebrowDesignSystems': '设计系统',
  'dsManager.yourSystemsHeading': '你的设计系统',
  'dsManager.filterAria': '筛选设计系统',
  'dsManager.filterAll': '全部',
  'dsManager.filterPublished': '已发布',
  'dsManager.filterDraft': '草稿',
  'dsManager.createTitle': '创建设计系统',
  'dsManager.createBody': '从零开始或导入已有系统。',
  'dsManager.createAction': '创建设计系统',
  'dsManager.emptyMine': '你还没有创建任何设计系统。',
  'dsManager.badgeDefault': '默认',
  'dsManager.rowMetaUpdated': '更新于 {date}',
  'dsManager.edit': '编辑',
  'dsManager.makeDefault': '设为默认',
  'dsManager.statusPublished': '已发布',
  'dsManager.statusDraft': '草稿',
  'dsManager.openSystemAria': '打开 {name}',
  'dsManager.deleteSystemAria': '删除 {name}',
  'dsManager.presetsAria': '官方预设设计系统',
  'dsManager.eyebrowLibrary': '库',
  'dsManager.eyebrowTemplates': '模板',
  'dsManager.yourTemplatesAria': '你的模板',
  'dsManager.emptyTemplates': '暂无模板。',
  'dsManager.templateDescFallback': '设计模板',
  'dsManager.comingSoonBadge': '即将推出',
  'dsManager.enterpriseDsTitle': '企业设计系统',
  'dsManager.enterpriseDsBody': '联系销售获取企业设计系统支持。',
  'dsManager.enterpriseTplTitle': '企业模板',
  'dsManager.enterpriseTplBody': '联系销售获取企业模板支持。',
  'settings.instructionsTitle': '指令 / 规则',
  'settings.instructionsSubtitle': '通过持久化指令自定义 Agent 行为。',
  'settings.instructionsNavSub': '自定义指令',
  'settings.customInstructionsDesc': '添加在所有对话中持久生效的指令。',
  'mcpClient.forwardedToLabel': '已转发至：',
  'mcpClient.notForwardedToLabel': '未转发至：',
  'mcpClient.forwardedAcpNote': 'Agent Communication Protocol 消息已转发。',
  'mcpClient.notForwardedNote': '来自此服务器的消息未转发。',
  'socialShare.openDesignSection': '分享 Open Design',
  'socialShare.openDesignTitle': '分享 Open Design',
  'socialShare.openDesignText': '来看看 Open Design — 面向现代团队的 AI 驱动设计工具。',
  'socialShare.openDesignCopyText': 'Open Design — AI 驱动设计工具',
  'socialShare.projectSection': '分享项目',
  'socialShare.projectTitle': '分享此项目',
  'socialShare.projectText': '来看看这个用 Open Design 制作的项目。',
  'socialShare.projectCopyText': 'Open Design 项目',
  'socialShare.deployFirst': '请先部署项目再分享。',
  ...
  'chat.annotationAttachImage': '附加图片',
  'chat.annotationAttachedImages': '已附加图片',
  'chat.annotationAttachedRemove': '移除',
  'chat.annotationAddToInput': '添加到输入',
  'chat.annotationAddingToInput': '正在添加…',
  'chat.forkedConversationTitle': '分叉对话',
  'chat.forkConversationFailed': '无法分叉对话',
  'chat.copyErrorDiagnostic': '复制错误诊断',
  'chat.activeFileEditingLabel': '编辑中',
  'chat.activeFilePlaceholder': '当前文件',
  'chat.designArtifactsShowMore': '显示更多',
  'chat.mode.chat.label': '提问',
  'chat.mode.chat.title': '聊天模式',
  'chat.mode.chat.summary': '适用于提问、分析和迭代的通用聊天。',
  'chat.mode.chat.solves': '问答、头脑风暴、代码审查、研究。',
  'chat.mode.chat.query1': '帮我理解这个设计',
  'chat.mode.chat.query2': '审查我的组件布局',
  'chat.mode.chat.query3': '建议改进',
  'chat.mode.design.label': '设计',
  'chat.mode.design.title': '设计模式',
  'chat.mode.design.summary': '带工具支持的聚焦设计生成。',
  'chat.mode.design.solves': 'UI 生成、布局设计、样式优化。',
  'chat.mode.design.query1': '创建一个仪表盘布局',
  'chat.mode.design.query2': '设计一个响应式导航',
  'chat.mode.design.query3': '构建一个卡片组件',
  'chat.mode.cardBestFor': '适用于',
  'chat.mode.cardTry': '试试',
  'chat.addContextTitle': '添加上下文',
  'browserUse.title': '灵感',
  'browserUse.summary': '从任意网站提取设计资源、令牌和模式。',
  'browserUse.searchAria': '搜索浏览器操作',
  'browserUse.searchPlaceholder': '搜索操作…',
  'browserUse.empty': '暂无可用操作。',
  'browserUse.unavailable': '当前环境不支持浏览器操作。',
  'browserUse.added': '已添加到聊天',
  'browserUse.category.assets': '资源',
  'browserUse.category.tokens': '令牌',
  'browserUse.category.motion': '动效',
  'browserUse.category.visual': '视觉',
  'browserUse.category.structure': '结构',
  'browserUse.category.project': '项目',
  'browserUse.category.general': '通用',
  'browserUse.input.none': '无',
  'browserUse.input.assetKind': '资源类型',
  'browserUse.input.optionalSelector': '选择器（可选）',
  'browserUse.input.requirementSelector': '选择器',
  'browserUse.input.selectorOptional': '选择器（可选）',
  'browserUse.input.scaleOne': '1×',
  'browserUse.input.selectorScaleTwo': '选择器',
  'browserUse.input.gridOverlay': '网格覆盖',
  'browserUse.input.bodySelector': 'Body 选择器',
  'browserUse.input.navigate': '导航到 URL',
  'browserUse.input.selector': '选择器',
  'browserUse.input.selectorText': '选择器文本',
  'browserUse.input.scroll': '滚动位置',
  'browserUse.input.terminalRun': '在终端运行',
  'browserUse.input.command': '命令',
  'browserUse.input.maxChars': '最大字符数',
  'browserUse.input.custom': '自定义',
  'browserUse.action.extract_logo.output': '已提取 Logo',
  'browserUse.action.list_images.output': '已列出图片',
  'browserUse.action.download_assets.output': '已下载资源',
  'browserUse.action.extract_svgs.output': '已提取 SVG',
  'browserUse.action.optimize_svgs.output': '已优化 SVG',
  'browserUse.action.extract_colors.output': '已提取颜色',
  'browserUse.action.extract_fonts.output': '已提取字体',
  'browserUse.action.extract_design_tokens.output': '已提取设计令牌',
  'browserUse.action.extract_type_scale.output': '已提取字号规范',
  'browserUse.action.extract_buttons.output': '已提取按钮',
  'browserUse.action.extract_grid_system.output': '已提取网格系统',
  'browserUse.action.extract_breakpoints.output': '已提取断点',
  'browserUse.action.extract_gradients.output': '已提取渐变',
  'browserUse.action.extract_shadows.output': '已提取阴影',
  'browserUse.action.extract_easings.output': '已提取缓动',
  'browserUse.action.export_tokens.output': '已导出令牌',
  'browserUse.action.extract_animations.output': '已提取动画',
  'browserUse.action.validate_view.output': '已验证视图',
  'browserUse.action.audit_layout.output': '已审查布局',
  'browserUse.action.audit_accessibility.output': '已审查无障碍',
  'browserUse.action.responsive_screenshots.output': '响应式截图',
  'browserUse.action.screenshot_full.output': '整页截图',
  'browserUse.action.screenshot_element.output': '元素截图',
  'browserUse.action.screenshot_with_grid.output': '带网格截图',
  'browserUse.action.screenshot_dark_mode.output': '深色模式截图',
  'browserUse.action.generate_styleguide.output': '已生成样式指南',
  'browserUse.action.extract_html.output': '已提取 HTML',
  'browserUse.action.extract_component_inventory.output': '已提取组件清单',
  'browserUse.action.extract_copy.output': '已提取文案',
  'browserUse.action.extract_nav.output': '已提取导航',
  'browserUse.action.extract_forms.output': '已提取表单',
  'browserUse.action.run_project.output': '已运行项目',
  'browserUse.action.detect_project.output': '已检测项目',
  'browserUse.action.page_info.output': '页面信息',
  'browserUse.action.snapshot.output': '快照',
  'browserUse.action.navigate.output': '已导航',
  'browserUse.action.click.output': '已点击',
  'browserUse.action.type_text.output': '已输入文本',
  'browserUse.action.scroll.output': '已滚动',
  'browserUse.action.extract_og_metadata.output': '已提取 OG 元数据',
  'browserUse.action.terminal_run.output': '终端输出',
  'browserUse.action.terminal_run_background.output': '终端后台运行中',
  'browserUse.action.terminal_read.output': '终端读取',
  'chat.designToolbox.title': '设计工具箱',
  'chat.designToolbox.tooltip': '打开设计工具箱',
  'chat.designToolbox.aria': '设计工具箱',
  'chat.designToolbox.lucky': '手气不错',
  'chat.designToolbox.searchPlaceholder': '搜索技能、插件…',
  'chat.designToolbox.searchAria': '搜索设计工具箱',
  'chat.designToolbox.followupSection': '后续操作',
  'chat.designToolbox.resourcesSection': '资源',
  'chat.designToolbox.selected': '已选择',
  'chat.designToolbox.noResources': '暂无可用资源',
  'chat.designToolbox.badge.video': '视频',
  'chat.designToolbox.badge.image': '图片',
  'chat.designToolbox.badge.motion': '动效',
  'chat.designToolbox.badge.polish': '优化',
  'chat.designToolbox.action.auto-match.title': '自动匹配设计',
  'chat.designToolbox.action.auto-match.badge': 'AI',
  'chat.designToolbox.action.auto-match.description': '自动将设计模式匹配到你的项目。',
  'chat.designToolbox.action.motion.title': '添加动效',
  'chat.designToolbox.action.motion.badge': '动效',
  'chat.designToolbox.action.motion.description': '添加动画和过渡效果。',
  'chat.designToolbox.action.motion-polish.title': '动效优化',
  'chat.designToolbox.action.motion-polish.badge': '动效',
  'chat.designToolbox.action.motion-polish.description': '优化动画，提升精致感。',
  'chat.designToolbox.action.anti-ai-polish.title': '去 AI 化处理',
  'chat.designToolbox.action.anti-ai-polish.badge': '优化',
  'chat.designToolbox.action.anti-ai-polish.description': '去除 AI 生成痕迹，呈现手工质感。',
  'chat.designToolbox.action.visual-polish.title': '视觉优化',
  'chat.designToolbox.action.visual-polish.badge': '优化',
  'chat.designToolbox.action.visual-polish.description': '优化间距、排版和视觉一致性。',
  'chat.designToolbox.action.image-gen.title': '生成图片',
  'chat.designToolbox.action.image-gen.badge': '图片',
  'chat.designToolbox.action.image-gen.description': '从文本描述生成图片。',
  'chat.designToolbox.action.video-gen.title': '生成视频',
  'chat.designToolbox.action.video-gen.badge': '视频',
  'chat.designToolbox.action.video-gen.description': '从图片或文本生成视频。',
  ...
  'chat.designToolbox.context.designSystem': '设计系统',
  'chat.designToolbox.context.folder': '文件夹',
  'chat.designToolbox.context.terminal': '终端',
  'chat.designToolbox.context.sideChat': '侧边聊天',
  'chat.designToolbox.context.liveArtifact': '实时工件',
  'chat.designToolbox.context.file': '文件',
  'chat.designToolbox.prompt.contextGeneric': '用户想要应用一个设计操作。',
  'chat.designToolbox.prompt.contextSpecific': '用户选择了：{name}',
  'chat.designToolbox.prompt.preserveDraft': '保留当前草稿状态。',
  'chat.designToolbox.prompt.selectedSkill': '已选技能：{name}',
  'chat.designToolbox.prompt.noSkill': '未选择技能。',
  'chat.designToolbox.prompt.autoMatchIntro': '自动匹配设计到当前上下文。',
  'chat.designToolbox.prompt.autoMatchStep1': '分析当前设计上下文。',
  'chat.designToolbox.prompt.autoMatchStep2': '识别匹配的模式。',
  'chat.designToolbox.prompt.autoMatchStep3': '应用最佳匹配。',
  'chat.designToolbox.prompt.autoMatchStep4': '验证结果。',
  'chat.designToolbox.prompt.motion': '为选中元素添加动效。',
  'chat.designToolbox.prompt.motionPolish': '优化现有的动效和过渡。',
  'chat.designToolbox.prompt.antiAiPolish': '去除 AI 生成痕迹，呈现自然外观。',
  'chat.designToolbox.prompt.visualPolish': '优化视觉一致性和间距。',
  'chat.designToolbox.prompt.imageGen': '根据描述生成图片。',
  'chat.designToolbox.prompt.videoGen': '从输入生成视频。',
  'chat.designToolbox.prompt.useSkill': '使用 {name} 技能。',
  'chat.designToolbox.prompt.skillInstruction': '严格遵循技能指令。',
  'chat.designToolbox.prompt.selectedResource': '已选资源：{name}',
  'chat.designToolbox.prompt.resourceDescription': '资源：{description}',
  'chat.designToolbox.prompt.pluginResource': '插件资源：{name}',
  'chat.designToolbox.prompt.mcpResource': 'MCP 资源：{name}',
  'chat.designToolbox.prompt.mcpTemplateResource': 'MCP 模板：{name}',
  'chat.designToolbox.prompt.connectorResource': '连接器：{name}',
  'chat.designToolbox.prompt.fileResource': '文件：{name}',
  'chat.designToolbox.prompt.resourceIndex': '资源 #{index}',
  'chat.designToolbox.prompt.searchableSkills': '可用技能：{skills}',
  'chat.designToolbox.prompt.searchablePlugins': '可用插件：{plugins}',
  'chat.designToolbox.prompt.availableMcp': '可用 MCP 服务器：{servers}',
  'chat.designToolbox.prompt.connectedConnectors': '已连接的连接器：{connectors}',
  'chat.designToolbox.prompt.referenceDesignFiles': '参考文件：{files}',
  'chat.designToolbox.prompt.mcpTemplateName': 'MCP 模板：{name}',
  'chat.designToolbox.prompt.processRule': '根据类型处理每个项目。',
  'chat.designToolbox.prompt.moreSuffix': '以及其他 {count} 个',
  'chat.designToolbox.prompt.compactLine': '{name}：{description}',
  'chat.mentionTabTabs': '标签页',
  'chat.mentionSectionTabs': '区块',
  'chat.queuedReorder': '已重新排序',
  'assistant.copyMarkdown': '复制回复 Markdown',
  'assistant.forkConversation': '分叉对话',
  'assistant.forkingConversation': '分叉中…',
  'assistant.shareToOpenDesign': '分享到 Open Design',
  'assistant.shareToOpenDesignBusy': '分享中…',
  'nextStep.title': '下一步',
  'nextStep.share': '分享',
  'nextStep.chipJoiner': '拼接',
  'nextStep.chipPolishVisual': '视觉优化',
  'nextStep.chipBrand': '品牌',
  'nextStep.chipConcise': '精简',
  'nextStep.chipSecondVersion': '第二版',
  'assistant.thought': '思考中',
  'assistant.thoughtFor': '思考中，用时 {duration}',
  'assistant.possiblePromptInjection': '检测到可能的提示注入',
  'assistant.statusPreparing': '准备中…',
  'questions.tabLabel': '问题',
  'questions.banner': '回答几个问题以继续。',
  'questions.bannerAnswered': 'Questions answered.',
  'questions.continue': '继续',
  'questions.generating': '正在生成问题…',
  'questions.skipAll': '全部跳过',
  'questions.autoSkipHint': '{seconds} 秒后自动跳过',
  ...
  'settings.onboardingCloudBody': "完成初始化配置即可开始设计 — 下方选择运行环境与语言。",
  'settings.onboardingCloudContinue': "继续",
  'settings.onboardingCloudOr': '或',
  'settings.onboardingCloudRights': '保留所有权利。',
  'settings.onboardingCloudSignIn': "开始设置",
  'settings.onboardingCloudTitle': "设置 Open Design",
