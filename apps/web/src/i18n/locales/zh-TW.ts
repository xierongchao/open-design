...
export const zhTW: Dict = {
  ...
  'settings.account': "帳戶",
  'settings.accountHint': "管理你的雲檔期帳戶",
  'settings.accountAbout': "帳號",
  'settings.accountAboutHint': "版本資訊與登出",
  'settings.accountSignOutTitle': "登出雲檔期",
  'settings.accountSignOutHint': "清除本地儲存的憑證並重新啟動應用以重新授權",
  ...
  'designFiles.newFolderTitle': '新建資料夾',
  'designFiles.newFolderLabel': '資料夾名稱',
  'designFiles.moveTitle': '移動到資料夾',
  'designFiles.moveLabel': '目標資料夾',
  'designFiles.moveRoot': '專案根目錄',
  'designFiles.moveNewFolder': '新建資料夾…',
  'designFiles.move': '移動',
  'designFiles.copyPath': '複製路徑',
  'designFiles.copiedPath': '已複製路徑',
  'designFiles.deleteFolderConfirm': '刪除資料夾「{name}」及其中所有內容嗎？',
  'designFiles.folderCreated': '已建立資料夾「{name}」',
  'designFiles.folderDeleted': '已刪除資料夾「{name}」',
  'designFiles.filesMoved': '已將 {n} 個檔案移動到 {dest}',
  'designFiles.newSubfolder': '新增子資料夾',
  'designFiles.untitledFolderName': '未命名資料夾',
  'designFiles.folderNameEmpty': '資料夾名稱不可為空。',
  'designFiles.addToFolder': '加入至資料夾',
  'designFiles.addToFolderEmpty': '尚無資料夾',
  'designFiles.selectFolder': '選擇資料夾',
  ...
  'designFiles.usefulInfoLabel': '實用資訊',
  'designFiles.usefulInfoTip': '雙擊檔案可在完整分頁中開啟。',
  'designFiles.batchSelect': '批次選擇',
  'designFiles.expandAll': "全部展開",
  'designFiles.collapseAll': "全部收合",
...
'designFiles.copyFailed': "複製失敗，請重試",
  ...
  'manualEdit.label.expandSpacing': '展開間距',
  'manualEdit.label.outerMargin': '外間距',
  'manualEdit.label.flexWrap': '換行',
  'manualEdit.label.flexNoWrap': '不換行',
  ...
  'fileViewer.exportImageCapturing': '正在產生預覽…',
