      ...
      import('grapesjs')
        .then((mod) => {
          ...
          const openSpacingInputEditor = (
            ...
            input.style.cssText = 'width:152px;padding:1px 4px;border:1px solid #444;border-radius:3px;background:#fff;color:#111;font:600 11px/1.4 system-ui;text-align:center;outline:none;-moz-appearance:textfield;';
