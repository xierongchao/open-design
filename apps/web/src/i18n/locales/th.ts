...
export const th: Dict = {
  ...
  'settings.accountHint': "จัดการบัญชี 云档期 ของคุณ",
  'settings.accountAbout': "บัญชี",
  'settings.accountAboutHint': "เวอร์ชันและออกจากระบบ",
  'settings.accountSignOutTitle': "ออกจากระบบ 云档期",
  'settings.accountSignOutHint': "ล้างข้อมูลประจำตัวที่จัดเก็บไว้ในเครื่องและรีสตาร์ทแอปเพื่อให้สิทธิ์อีกครั้ง",
  ...
  'workspace.closeTabsToRight': 'ปิดแท็บด้านขวา',
  'workspace.closeOtherTabs': 'ปิดแท็บอื่น',
  'workspace.closeAllTabs': 'ปิดแท็บทั้งหมด',
  ...
  'designFiles.moveRoot': 'รากโปรเจกต์',
  'designFiles.moveNewFolder': 'โฟลเดอร์ใหม่…',
  'designFiles.move': 'ย้าย',
  'designFiles.copyPath': 'คัดลอกพาธ',
  'designFiles.copiedPath': 'คัดลอกพาธแล้ว',
  ...
  'designFiles.filesMoved': 'ย้าย {n} ไปยัง {dest} แล้ว',
  'designFiles.newSubfolder': 'โฟลเดอร์ย่อยใหม่',
  'designFiles.untitledFolderName': 'โฟลเดอร์ไม่มีชื่อ',
  'designFiles.folderNameEmpty': 'ชื่อโฟลเดอร์ต้องไม่ว่าง',
  'designFiles.addToFolder': 'เพิ่มไปยังโฟลเดอร์',
  'designFiles.addToFolderEmpty': 'ยังไม่มีโฟลเดอร์',
  'designFiles.selectFolder': 'เลือกโฟลเดอร์',
  ...
  'designFiles.modifiedExt': 'แก้ไข {time} · {size} · {ext}',
  'designFiles.usefulInfoLabel': 'ข้อมูลที่เป็นประโยชน์',
  'designFiles.usefulInfoTip': 'ดับเบิลคลิกไฟล์เพื่อเปิดในแท็บเต็ม',
  'designFiles.batchSelect': 'การเลือกแบบกลุ่ม',
  'designFiles.expandAll': "ขยายทั้งหมด",
  'designFiles.collapseAll': "ย่อทั้งหมด",
...
'designFiles.copyFailed': "คัดลอกไม่สำเร็จ กรุณาลองอีกครั้ง",
  ...
  'manualEdit.height': "ความสูง",
  'manualEdit.canvasWidth': "พื้นที่ ก",
  'manualEdit.canvasHeight': "พื้นที่ ส",
  ...
  'fileViewer.exportImageScaleLabel': 'ขนาด',
  'fileViewer.exportImageSaving': 'กำลังบันทึกรูปภาพ…',
  'fileViewer.exportImageCapturing': 'กำลังสร้างตัวอย่าง…',
