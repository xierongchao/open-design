...
export const de: Dict = {
  ...
  'settings.accountHint': "云档期-Konto verwalten",
  'settings.accountAbout': "Konto",
  'settings.accountAboutHint': "Version und Abmeldung",
  'settings.accountSignOutTitle': "Von 云档期 abmelden",
  'settings.accountSignOutHint': "Lokal gespeicherte Anmeldedaten löschen und App neu starten, um sich erneut zu autorisieren",
  'settings.accountSignOut': "Abmelden",
  ...
  'workspace.closeTabsToRight': 'Rechte Tabs schließen',
  'workspace.closeOtherTabs': 'Andere Tabs schließen',
  'workspace.closeAllTabs': 'Alle Tabs schließen',
  ...
  'designFiles.moveRoot': 'Projektwurzel',
  ...
  'designFiles.deleteFolderConfirm': 'Ordner "{name}" und gesamten Inhalt löschen?',
  ...
  'designFiles.newSubfolder': 'Neuer Unterordner',
  'designFiles.untitledFolderName': 'Unbenannter Ordner',
  'designFiles.folderNameEmpty': 'Ordnername darf nicht leer sein.',
  'designFiles.addToFolder': 'Zu Ordner hinzufügen',
  'designFiles.addToFolderEmpty': 'Noch keine Ordner',
  'designFiles.selectFolder': 'Ordner auswählen',
  ...
  'designFiles.usefulInfoLabel': 'Nützliche Info',
  'designFiles.usefulInfoTip': 'Doppelklicke eine Datei, um sie in einem vollständigen Tab zu öffnen.',
  'designFiles.batchSelect': 'Batch-Auswahl',
  'designFiles.expandAll': "Alle aufklappen",
  'designFiles.collapseAll': "Alle zuklappen",
...
'designFiles.copyFailed': "Kopieren fehlgeschlagen, bitte erneut versuchen",
  ...
  'fileViewer.exportImageScaleLabel': 'Skalierung',
  'fileViewer.exportImageSaving': 'Bild wird gespeichert…',
  'fileViewer.exportImageCapturing': 'Vorschau wird erstellt…',
