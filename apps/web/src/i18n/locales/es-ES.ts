...
export const esES: Dict = {
  ...
  'settings.accountHint': "Administra tu cuenta de 云档期",
  'settings.accountAbout': "Cuenta",
  'settings.accountAboutHint': "Versión y cerrar sesión",
  'settings.accountSignOutTitle': "Cerrar sesión en 云档期",
  'settings.accountSignOutHint': "Borra la credencial almacenada localmente y reinicia la app para volver a autorizar",
  ...
  'workspace.closeTabsToRight': 'Cerrar pestañas a la derecha',
  'workspace.closeOtherTabs': 'Cerrar otras pestañas',
  'workspace.closeAllTabs': 'Cerrar todas las pestañas',
  ...
  'designFiles.newFolderLabel': 'Nombre de carpeta',
  'designFiles.moveTitle': 'Mover a carpeta',
  ...
  'designFiles.filesMoved': '{n} movidos a {dest}',
  'designFiles.newSubfolder': 'Nueva subcarpeta',
  'designFiles.untitledFolderName': 'Carpeta sin nombre',
  'designFiles.folderNameEmpty': 'El nombre de la carpeta no puede estar vacío.',
  'designFiles.addToFolder': 'Añadir a la carpeta',
  'designFiles.addToFolderEmpty': 'Aún no hay carpetas',
  'designFiles.selectFolder': 'Seleccionar carpeta',
  ...
  'designFiles.sectionStylesheets': 'Hojas de estilo',
  'designFiles.sectionDocuments': 'Documentos',
  'designFiles.kindStylesheet': 'Hoja de estilo',
  'designFiles.modifiedExt': 'Modificado {time} · {size} · {ext}',
  'designFiles.usefulInfoLabel': 'Información útil',
  'designFiles.usefulInfoTip': 'Haz doble clic en un archivo para abrirlo en una pestaña completa.',
  'designFiles.batchSelect': 'Selección por lotes',
...
'designFiles.copyFailed': "Error al copiar, inténtalo de nuevo",
  ...
  'fileViewer.exportImageScaleLabel': 'Escala',
  'fileViewer.exportImageSaving': 'Guardando imagen…',
  'fileViewer.exportImageCapturing': 'Generando vista previa…',
