...
export const ru: Dict = {
  ...
  'settings.accountHint': "Управление аккаунтом 云档期",
  'settings.accountAbout': "Аккаунт",
  'settings.accountAboutHint': "Версия и выход",
  'settings.accountSignOutTitle': "Выйти из 云档期",
  'settings.accountSignOutHint': "Очистить локально сохранённые учётные данные и перезапустить приложение для повторной авторизации",
  'settings.accountSignOut': "Выйти",
  ...
  'workspace.closeTabsToRight': 'Закрыть вкладки справа',
  'workspace.closeOtherTabs': 'Закрыть другие вкладки',
  'workspace.closeAllTabs': 'Закрыть все вкладки',
  ...
  'designFiles.copyPath': 'Копировать путь',
  'designFiles.copiedPath': 'Путь скопирован',
  'designFiles.deleteFolderConfirm': 'Удалить папку "{name}" и все ее содержимое?',
  'designFiles.folderCreated': 'Папка "{name}" создана',
  'designFiles.folderDeleted': 'Папка "{name}" удалена',
  'designFiles.filesMoved': '{n} перемещено в {dest}',
  'designFiles.newSubfolder': 'Новая вложенная папка',
  'designFiles.untitledFolderName': 'Безымянная папка',
  'designFiles.folderNameEmpty': 'Имя папки не может быть пустым.',
  'designFiles.addToFolder': 'Добавить в папку',
  'designFiles.addToFolderEmpty': 'Папок пока нет',
  'designFiles.selectFolder': 'Выбрать папку',
  ...
  'designFiles.usefulInfoTip': 'Дважды щелкните файл, чтобы открыть его в полной вкладке.',
  'designFiles.batchSelect': 'Пакетный выбор',
...
'designFiles.copyFailed': "Не удалось скопировать, попробуйте снова",
  ...
  'fileViewer.exportImageScaleLabel': 'Масштаб',
  'fileViewer.exportImageSaving': 'Сохранение изображения…',
  'fileViewer.exportImageCapturing': 'Создание предпросмотра…',
