...
export const ko: Dict = {
  ...
  'settings.account': "계정",
  'settings.accountHint': "云档期 계정 관리",
  'settings.accountAbout': "계정",
  'settings.accountAboutHint': "버전 및 로그아웃",
  'settings.accountSignOutTitle': "云档期에서 로그아웃",
  'settings.accountSignOutHint': "로컬에 저장된 자격 증명을 지우고 앱을 다시 시작하여 다시 인증합니다",
  'settings.accountSignOut': "로그아웃",
  ...
  'workspace.closeTabsToRight': '오른쪽 탭 닫기',
  'workspace.closeOtherTabs': '다른 탭 닫기',
  'workspace.closeAllTabs': '모든 탭 닫기',
  ...
  'designFiles.deleteFolderConfirm': '"{name}" 폴더와 모든 내용을 삭제할까요?',
  'designFiles.folderCreated': '"{name}" 폴더가 생성됨',
  'designFiles.folderDeleted': '"{name}" 폴더가 삭제됨',
  'designFiles.filesMoved': '{n}개를 {dest}(으)로 이동',
  'designFiles.newSubfolder': '새 하위 폴더',
  'designFiles.untitledFolderName': '이름 없는 폴더',
  'designFiles.folderNameEmpty': '폴더 이름은 비워둘 수 없습니다.',
  'designFiles.addToFolder': '폴더에 추가',
  'designFiles.addToFolderEmpty': '폴더가 없습니다',
  'designFiles.selectFolder': '폴더 선택',
  ...
  'designFiles.modifiedExt': '{time} 수정 · {size} · {ext}',
  'designFiles.usefulInfoLabel': '유용한 정보',
  'designFiles.usefulInfoTip': '파일을 두 번 클릭하면 전체 탭에서 열립니다.',
  'designFiles.batchSelect': '일괄 선택',
...
'designFiles.copyFailed': "복사하지 못했습니다. 다시 시도해 주세요",
  ...
  'fileViewer.exportImageScaleLabel': '배율',
  'fileViewer.exportImageSaving': '이미지 저장 중…',
  'fileViewer.exportImageCapturing': '미리보기 생성 중…',
