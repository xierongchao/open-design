...
export const tr: Dict = {
  ...
  'settings.accountHint': "云档期 hesabınızı yönetin",
  'settings.accountAbout': "Hesap",
  'settings.accountAboutHint': "Sürüm ve oturumu kapat",
  'settings.accountSignOutTitle': "云档期 oturumunu kapat",
  'settings.accountSignOutHint': "Yerel olarak depolanan kimlik bilgilerini temizleyin ve yeniden yetkilendirmek için uygulamayı yeniden başlatın",
  'settings.accountSignOut': "Oturumu kapat",
  ...
  'designFiles.filesMoved': '{n}, {dest} konumuna taşındı',
  'designFiles.newSubfolder': 'Yeni alt klasör',
  'designFiles.untitledFolderName': 'Adsız klasör',
  'designFiles.folderNameEmpty': 'Klasör adı boş olamaz.',
  'designFiles.addToFolder': 'Klasöre ekle',
  'designFiles.addToFolderEmpty': 'Henüz klasör yok',
  'designFiles.selectFolder': 'Klasör seç',
  ...
  'designFiles.modifiedExt': 'Değiştirildi {time} · {size} · {ext}',
  'designFiles.usefulInfoLabel': 'Yararlı bilgi',
  'designFiles.usefulInfoTip': 'Bir dosyayı tam sekmede açmak için çift tıklayın.',
  'designFiles.batchSelect': 'Toplu seçim',
...
'designFiles.copyFailed': "Kopyalama başarısız, tekrar deneyin",
  ...
  'fileViewer.exportImageScaleLabel': 'Ölçek',
  'fileViewer.exportImageSaving': 'Görsel kaydediliyor…',
  'fileViewer.exportImageCapturing': 'Önizleme oluşturuluyor…',
