...
export const en: Dict = {
  ...
  'settings.accountHint': "Manage your 云档期 account",
  'settings.accountAbout': "Account",
  'settings.accountAboutHint': "Version and sign out",
  'settings.accountSignOutTitle': "Sign out of 云档期",
  'settings.accountSignOutHint': "Clear the locally stored credential and restart the app to re-authorize",
  ...
  'workspace.searchFilesPlaceholder': 'Search files or tabs',
  ...
  'workspace.sideChatContextBanner': 'Side chat uses this workspace as context.',
  'workspace.sideChatDefaultTitle': 'Side chat',
  'workspace.newTerminal': 'New Terminal',
  'workspace.newTerminalDescription': 'Open a shell in this project',
  'workspace.newBrowser': 'New Browser',
  'workspace.newBrowserDescription': 'Open a browser tab for references',
  'workspace.terminalStarting': 'Starting terminal…',
  'workspace.terminalStartingDescription': 'Connecting to the project shell.',
  'workspace.terminalSessionEnded': 'Terminal session ended.',
  'workspace.terminalReconnecting': 'Reconnecting terminal…',
  'workspace.terminalStartFailed': 'Could not start the terminal.',
  'workspace.terminalRestart': 'Restart terminal',
  ...
  'designFiles.deleteFolderConfirm': 'Delete folder "{name}" and all of its contents?',
  'designFiles.folderCreated': 'Folder "{name}" created',
  'designFiles.folderDeleted': 'Folder "{name}" deleted',
  'designFiles.filesMoved': '{n} moved to {dest}',
  'designFiles.newSubfolder': 'New subfolder',
  'designFiles.untitledFolderName': 'Untitled folder',
    'designFiles.newArtboard': 'New artboard',
  'designFiles.artboardCreated': 'Created artboard "{name}"',
  'designFiles.exportPdf': 'Export PDF',
  'designFiles.exportImages': 'Export images',
  'designFiles.exportZip': 'Download as ZIP',
  'designFiles.imageFormatTitle': 'Export Image Settings',
  'designFiles.imageFormat': 'Format',
  'designFiles.imageScale': 'Scale',
  'designFiles.exportBtn': 'Export',
  'designFiles.rootNodeMenu': 'Root menu',
  'designFiles.noHtmlForPdf': 'No HTML files to export as PDF.',
  'designFiles.noHtmlForImage': 'No HTML files to export as images.',
'designFiles.folderNameEmpty': 'Folder name cannot be empty.',
  'designFiles.addToFolder': 'Add to folder',
  'designFiles.addToFolderEmpty': 'No folders yet',
  'designFiles.selectFolder': 'Select Folder',
  ...
  'designFiles.usefulInfoTip': 'Double-click a file to open it in a full tab.',
  'designFiles.batchSelect': 'Batch select',
  'designFiles.expandAll': "Expand all",
  'designFiles.collapseAll': "Collapse all",
  'designFiles.copyFailed': "Copy failed, please try again",
  ...
  'fileViewer.codeUnsavedConfirm': 'You have unsaved code changes. Discard changes and leave?',
  ...
  'manualEdit.canvasWidth': "Canvas W",
  'manualEdit.canvasHeight': "Canvas H",
  ...
  'manualEdit.section.frame': 'Frame',
  'manualEdit.section.position': 'Position',
  'manualEdit.section.autoLayout': 'Auto Layout',
  'manualEdit.section.appearance': 'Appearance',
  'manualEdit.section.fill': 'Fill',
  'manualEdit.section.stroke': 'Stroke',
  'manualEdit.section.effect': 'Effect',
  'manualEdit.section.typography': 'Typography',
  'manualEdit.section.size': 'Size',
  'manualEdit.section.margin': 'Margin',
  'manualEdit.section.colors': 'Colors',
  'manualEdit.section.pageStyles': 'Page Styles',
  'manualEdit.label.gap': 'Gap',
  'manualEdit.label.padding': 'Padding',
  'manualEdit.autoLayout.none': 'None',
  'manualEdit.autoLayout.vertical': 'Vertical',
  'manualEdit.autoLayout.horizontal': 'Horizontal',
  'manualEdit.autoLayout.grid': 'Grid',
  'manualEdit.autoLayout.add': 'Add auto layout',
  'manualEdit.autoLayout.remove': 'Remove auto layout',
  'manualEdit.autoLayout.horizontalGap': 'Horizontal gap',
  'manualEdit.autoLayout.verticalGap': 'Vertical gap',
  'manualEdit.autoLayout.horizontalPadding': 'Left/right padding',
  'manualEdit.autoLayout.verticalPadding': 'Top/bottom padding',
  'manualEdit.autoLayout.horizontalDistribution': 'Horizontal distribution',
  'manualEdit.autoLayout.verticalDistribution': 'Vertical distribution',
  'manualEdit.label.clipContent': 'Clip content',
  'manualEdit.label.opacity': 'Opacity',
  'manualEdit.label.radius': 'Radius',
  'manualEdit.label.strokeWidth': 'Width',
  'manualEdit.label.addShadow': 'Add shadow',
  'manualEdit.label.dropShadow': 'Drop shadow / Blur',
  'manualEdit.label.lineHeight': 'Line',
  'manualEdit.label.letterSpacing': 'Letter spacing',
  'manualEdit.label.expandStroke': 'Expand stroke',
  'manualEdit.label.strokeCenter': 'Center stroke',
  'manualEdit.label.strokeInside': 'Inside stroke',
  'manualEdit.label.strokeOutside': 'Outside stroke',
  'manualEdit.label.strokeSolid': 'Solid',
  'manualEdit.label.strokeDashed': 'Dashed',
  'manualEdit.label.dashGap': 'Dash gap',
  'manualEdit.label.collapseSpacing': 'Collapse spacing',
  'manualEdit.label.expandSpacing': 'Expand spacing',
  'manualEdit.label.outerMargin': 'Margin',
  'manualEdit.label.flexWrap': 'Wrap',
  'manualEdit.label.flexNoWrap': 'No wrap',
  'manualEdit.hint.clickElement': 'Click an element in the preview to edit its properties.',
  'manualEdit.hint.toggleShortcut': '⌘\\ to toggle this panel',
  'manualEdit.undoLimitReached': 'No more undo history available.',
  ...
  'fileViewer.interactiveMode': 'Interactive',
  'fileViewer.editMode': 'Edit',
  ...
  'fileViewer.exportImageScaleLabel': 'Scale',
  'fileViewer.exportImageSaving': 'Saving image…',
  'fileViewer.exportImageCapturing': 'Generating preview…',
  ...
  'settings.onboardingNewsletterTitle': 'Get the newsletter',
  'settings.onboardingNewsletterBody': 'Receive tips, updates, and design inspiration in your inbox.',
  'settings.modelsLoadedCount': '✓ {count} models loaded.',
  'settings.byokVideoModel': 'Video model',
  'settings.byokVideoI2vHint': 'Image-to-video model for motion generation.',
  'settings.byokSpeechModel': 'Speech model',
  'settings.byokSpeechVoice': 'Voice',
  'settings.byokModelDefaultOption': 'Use default',
  'settings.designSystemsSourceShadcn': 'shadcn/ui',
  'settings.designSystemsShadcnReference': 'Import components from the shadcn/ui registry.',
  'settings.designSystemsImportShadcn': 'Import shadcn/ui',
  'newsletter.label': 'Newsletter (optional)',
  'newsletter.placeholder': 'you@example.com',
  'entry.discordLabel': 'Join Discord',
  'entry.discordAria': 'Join the Open Design Discord community',
  'entry.discordAriaWithOnline': 'Join the Open Design Discord community — {count} members online',
  'entry.discordOnlineLabel': '{count} online',
  'entry.followXLabel': 'Follow on X',
  'entry.navExpand': 'Expand navigation',
  'entry.navCollapse': 'Collapse navigation',
  'homeHero.templatesScrollHint': 'Scroll to see more templates',
  'homeHero.templatesCollapse': 'Collapse templates',
  'homeHero.addMenu': 'Add',
  'homeHero.addPlugin': 'Plugin',
  'homeHero.addConnectors': 'Connector',
  'homeHero.addMcp': 'MCP Server',
  'homeHero.noPlugins': 'No plugins available',
  'homeHero.noMcp': 'No MCP servers available',
  'homeHero.noConnectors': 'No connectors available',
  'homeHero.subTypeAria': 'Subtitle options',
  'handoff.optionsAria': 'Handoff options',
  'handoff.editorSection': 'Editor handoff',
  'handoff.cliSection': 'CLI handoff',
  'handoff.clickOpen': 'Click to open',
  'handoff.framework': 'Framework',
  'handoff.framework.react': 'React',
  'handoff.framework.vue': 'Vue',
  'handoff.framework.svelte': 'Svelte',
  'handoff.framework.solid': 'Solid',
  'handoff.framework.next': 'Next.js',
  'handoff.framework.vanilla': 'Vanilla',
  'handoff.frameworkPrompt.react': 'a React component',
  'handoff.frameworkPrompt.vue': 'a Vue component',
  'handoff.frameworkPrompt.svelte': 'a Svelte component',
  'handoff.frameworkPrompt.solid': 'a Solid component',
  'handoff.frameworkPrompt.next': 'a Next.js page',
  'handoff.frameworkPrompt.vanilla': 'vanilla HTML/CSS/JS',
  'handoff.amrWebsite': 'Open Design website',
  'handoff.copyPrompt': 'Copy prompt',
  'handoff.copyPromptForTarget': 'Copy prompt for {target}',
  'handoff.copied': 'Copied!',
  'handoff.projectPathUnavailable': 'Project path unavailable',
  'handoff.copyFailed': 'Failed to copy',
  'handoff.promptIntro': 'You are an expert front-end developer implementing a design from Open Design.',
  'handoff.promptTarget': 'Target: produce {framework}',
  'handoff.promptCli': 'Open Design CLI',
  'handoff.promptStepsLead': 'Steps:',
  'handoff.promptReadFiles': 'Read the referenced design files',
  'handoff.promptKeepDesign': 'Keep the design intent, layout, and visual fidelity',
  'handoff.promptProduceCode': 'Produce clean, production-ready code',
  'handoff.promptVerify': 'Verify the output matches the design',
  'handoff.promptCommandHint': 'Run: {command}',
  'handoff.promptProject': 'Project: {name}',
  'handoff.promptProjectId': 'Project ID: {id}',
  'automations.eyebrow': 'Scheduled agent sessions',
  'automations.title': 'Automations',
  'automations.lede': 'Automate recurring design and development tasks.',
  'automations.summaryAria': 'Automation summary',
  'automations.metricActive': '{count} active',
  'automations.metricPaused': '{count} paused',
  'automations.metricTemplates': '{count} templates',
  ...
  'automations.emptyBody': 'Create your first automation to streamline recurring tasks.',
  'automations.targetNewEachRun': 'New target each run',
  'automations.lastRun': 'Last run',
  'automations.openResult': 'Open result',
  'automations.run': 'Run',
  'automations.runNowTitle': 'Run now',
  ...
  'automations.deleteConfirm': 'This cannot be undone.',
  'automations.proposalsTitle': 'Proposals',
  'automations.proposalsSub': 'Pending changes from recent runs.',
  'automations.proposalsPending': '{count} pending',
  'automations.apply': 'Apply',
  'automations.reject': 'Reject',
  'automations.proposalsDismissReason': 'Dismissed: {reason}',
  'automations.templatesTitle': 'Templates',
  'automations.templatesSub': 'Start from a pre-built automation.',
  'automations.templatesCount': '{count} templates',
  'automations.templateFiltersAria': 'Template filters',
  'automations.templatesEmptyTitle': 'No templates match',
  'automations.templatesEmptyBody': 'Try adjusting your filters.',
  ...
  'automations.runHistoryLatest': 'Latest',
  'automations.crystallize': 'Crystallize',
  'automations.crystallizing': 'Crystallizing…',
  'automations.crystallizeTitle': 'Crystallize conversation',
  'automations.openConversation': 'Open conversation',
  'automations.runHistoryAria': 'Run history',
  'automations.proposalsAria': 'Proposals',
  'automations.templatesAria': 'Templates',
  'automations.runInProgress': 'Run in progress',
  'automations.scheduleStatusPaused': 'Paused',
  'automations.nextRunManualOnly': 'Manual only',
  'automations.nextRunScheduled': 'Scheduled',
  'automations.nextRunAt': 'Next: {date}',
  ...
  'automations.proposalTargetTemplate': 'Template',
  ...
  'automations.tpl.memoryRefresh.title': 'Memory Refresh',
  'automations.tpl.memoryRefresh.desc': 'Periodically refresh the project memory index.',
  'automations.tpl.designSystemRefresh.title': 'Design System Refresh',
  'automations.tpl.designSystemRefresh.desc': 'Sync design tokens and component definitions.',
  'automations.tpl.liveArtifactRegistry.title': 'Live Artifact Registry',
  'automations.tpl.liveArtifactRegistry.desc': 'Maintain a registry of live design artifacts.',
  'automations.tpl.orbitDashboard.title': 'Orbit Dashboard',
  'automations.tpl.orbitDashboard.desc': 'Generate an orbit-style project dashboard.',
  'automations.tpl.releaseNotes.title': 'Release Notes',
  'automations.tpl.releaseNotes.desc': 'Draft release notes from recent commits.',
  'automations.tpl.qualityRegressionWatch.title': 'Quality Regression Watch',
  'automations.tpl.qualityRegressionWatch.desc': 'Monitor code quality metrics over time.',
  'automations.tpl.orbitDaily.title': 'Orbit Daily Digest',
  'automations.tpl.orbitDaily.desc': 'Produce a daily project activity digest.',
  'automations.tpl.liveStatusBoard.title': 'Live Status Board',
  'automations.tpl.liveStatusBoard.desc': 'Publish a live project status page.',
  'dsManager.areaAria': 'Design systems area',
  'dsManager.tabDesignSystem': 'Design Systems',
  'dsManager.tabTemplate': 'Templates',
  ...
  'dsManager.yourSystemsHeading': 'Your design systems',
  ...
  'dsManager.createTitle': 'Create a design system',
  'dsManager.createBody': 'Start from scratch or import an existing system.',
  'dsManager.createAction': 'Create design system',
  'dsManager.emptyMine': 'You haven\'t created any design systems yet.',
  'dsManager.badgeDefault': 'Default',
  'dsManager.rowMetaUpdated': 'Updated {date}',
  'dsManager.edit': 'Edit',
  'dsManager.makeDefault': 'Make default',
  'dsManager.statusPublished': 'Published',
  'dsManager.statusDraft': 'Draft',
  'dsManager.openSystemAria': 'Open {name}',
  'dsManager.deleteSystemAria': 'Delete {name}',
  'dsManager.presetsAria': 'Official preset design systems',
  'dsManager.eyebrowLibrary': 'Library',
  'dsManager.eyebrowTemplates': 'Templates',
  'dsManager.yourTemplatesAria': 'Your templates',
  'dsManager.emptyTemplates': 'No templates yet.',
  'dsManager.templateDescFallback': 'Design template',
  'dsManager.comingSoonBadge': 'Coming soon',
  'dsManager.enterpriseDsTitle': 'Enterprise design systems',
  'dsManager.enterpriseDsBody': 'Contact sales for enterprise design system support.',
  'dsManager.enterpriseTplTitle': 'Enterprise templates',
  'dsManager.enterpriseTplBody': 'Contact sales for enterprise template support.',
  'settings.instructionsTitle': 'Instructions / Rules',
  'settings.instructionsSubtitle': 'Customize agent behavior with persistent instructions.',
  'settings.instructionsNavSub': 'Custom instructions',
  'settings.customInstructionsDesc': 'Add instructions that persist across all conversations.',
  'mcpClient.forwardedToLabel': 'Forwarded to:',
  'mcpClient.notForwardedToLabel': 'Not forwarded to:',
  'mcpClient.forwardedAcpNote': 'Agent Communication Protocol messages are forwarded.',
  'mcpClient.notForwardedNote': 'Messages from this server are not forwarded.',
  'socialShare.openDesignSection': 'Share Open Design',
  'socialShare.openDesignTitle': 'Share Open Design',
  'socialShare.openDesignText': 'Check out Open Design — AI-powered design tools for modern teams.',
  'socialShare.openDesignCopyText': 'Open Design — AI-powered design tools',
  'socialShare.projectSection': 'Share project',
  'socialShare.projectTitle': 'Share this project',
  'socialShare.projectText': 'Check out this project made with Open Design.',
  'socialShare.projectCopyText': 'Open Design project',
  'socialShare.deployFirst': 'Deploy your project first to share it.',
  'socialShare.copied': 'Copied!',
  'socialShare.platform.x': 'X (Twitter)',
  ...
  'chat.annotationAttachedRemove': 'Remove',
  'chat.annotationAddToInput': 'Add to input',
  'chat.annotationAddingToInput': 'Adding…',
  'chat.forkedConversationTitle': 'Forked conversation',
  'chat.forkConversationFailed': 'Could not fork conversation',
  'chat.copyErrorDiagnostic': 'Copy error diagnostic',
  'chat.activeFileEditingLabel': 'Editing',
  'chat.activeFilePlaceholder': 'Active file',
  'chat.designArtifactsShowMore': 'Show more',
  'chat.mode.chat.label': 'Ask',
  'chat.mode.chat.title': 'Chat mode',
  'chat.mode.chat.summary': 'General-purpose chat for questions, analysis, and iteration.',
  'chat.mode.chat.solves': 'Questions, brainstorming, code review, research.',
  'chat.mode.chat.query1': 'Help me understand this design',
  'chat.mode.chat.query2': 'Review my component layout',
  'chat.mode.chat.query3': 'Suggest improvements',
  'chat.mode.design.label': 'Design',
  'chat.mode.design.title': 'Design mode',
  'chat.mode.design.summary': 'Focused design generation with tool support.',
  'chat.mode.design.solves': 'UI generation, layout design, style refinement.',
  'chat.mode.design.query1': 'Create a dashboard layout',
  'chat.mode.design.query2': 'Design a responsive navigation',
  'chat.mode.design.query3': 'Build a card component',
  'chat.mode.cardBestFor': 'Best for',
  'chat.mode.cardTry': 'Try',
  'chat.addContextTitle': 'Add context',
  'browserUse.title': 'Inspiration',
  'browserUse.summary': 'Extract design assets, tokens, and patterns from any website.',
  'browserUse.searchAria': 'Search browser use actions',
  'browserUse.searchPlaceholder': 'Search actions…',
  'browserUse.empty': 'No actions available.',
  'browserUse.unavailable': 'Browser use is not available in this environment.',
  'browserUse.added': 'Added to chat',
  'browserUse.category.assets': 'Assets',
  'browserUse.category.tokens': 'Tokens',
  'browserUse.category.motion': 'Motion',
  'browserUse.category.visual': 'Visual',
  'browserUse.category.structure': 'Structure',
  'browserUse.category.project': 'Project',
  'browserUse.category.general': 'General',
  'browserUse.input.none': 'None',
  'browserUse.input.assetKind': 'Asset kind',
  'browserUse.input.optionalSelector': 'Selector (optional)',
  'browserUse.input.requirementSelector': 'Selector',
  'browserUse.input.selectorOptional': 'Selector (optional)',
  'browserUse.input.scaleOne': '1×',
  'browserUse.input.selectorScaleTwo': 'Selector',
  'browserUse.input.gridOverlay': 'Grid overlay',
  'browserUse.input.bodySelector': 'Body selector',
  'browserUse.input.navigate': 'Navigate to URL',
  'browserUse.input.selector': 'Selector',
  'browserUse.input.selectorText': 'Selector text',
  'browserUse.input.scroll': 'Scroll position',
  'browserUse.input.terminalRun': 'Run in terminal',
  'browserUse.input.command': 'Command',
  'browserUse.input.maxChars': 'Max characters',
  'browserUse.input.custom': 'Custom',
  'browserUse.action.extract_logo.output': 'Extracted logo',
  'browserUse.action.list_images.output': 'Listed images',
  'browserUse.action.download_assets.output': 'Downloaded assets',
  'browserUse.action.extract_svgs.output': 'Extracted SVGs',
  'browserUse.action.optimize_svgs.output': 'Optimized SVGs',
  'browserUse.action.extract_colors.output': 'Extracted colors',
  'browserUse.action.extract_fonts.output': 'Extracted fonts',
  'browserUse.action.extract_design_tokens.output': 'Extracted design tokens',
  'browserUse.action.extract_type_scale.output': 'Extracted type scale',
  'browserUse.action.extract_buttons.output': 'Extracted buttons',
  'browserUse.action.extract_grid_system.output': 'Extracted grid system',
  'browserUse.action.extract_breakpoints.output': 'Extracted breakpoints',
  'browserUse.action.extract_gradients.output': 'Extracted gradients',
  'browserUse.action.extract_shadows.output': 'Extracted shadows',
  'browserUse.action.extract_easings.output': 'Extracted easings',
  'browserUse.action.export_tokens.output': 'Exported tokens',
  'browserUse.action.extract_animations.output': 'Extracted animations',
  'browserUse.action.validate_view.output': 'Validated view',
  'browserUse.action.audit_layout.output': 'Audited layout',
  'browserUse.action.audit_accessibility.output': 'Audited accessibility',
  'browserUse.action.responsive_screenshots.output': 'Responsive screenshots',
  'browserUse.action.screenshot_full.output': 'Full page screenshot',
  'browserUse.action.screenshot_element.output': 'Element screenshot',
  'browserUse.action.screenshot_with_grid.output': 'Screenshot with grid',
  'browserUse.action.screenshot_dark_mode.output': 'Dark mode screenshot',
  'browserUse.action.generate_styleguide.output': 'Generated style guide',
  'browserUse.action.extract_html.output': 'Extracted HTML',
  'browserUse.action.extract_component_inventory.output': 'Extracted component inventory',
  'browserUse.action.extract_copy.output': 'Extracted copy',
  'browserUse.action.extract_nav.output': 'Extracted navigation',
  'browserUse.action.extract_forms.output': 'Extracted forms',
  'browserUse.action.run_project.output': 'Ran project',
  'browserUse.action.detect_project.output': 'Detected project',
  'browserUse.action.page_info.output': 'Page info',
  'browserUse.action.snapshot.output': 'Snapshot',
  'browserUse.action.navigate.output': 'Navigated',
  'browserUse.action.click.output': 'Clicked',
  'browserUse.action.type_text.output': 'Typed text',
  'browserUse.action.scroll.output': 'Scrolled',
  'browserUse.action.extract_og_metadata.output': 'Extracted OG metadata',
  'browserUse.action.terminal_run.output': 'Terminal output',
  'browserUse.action.terminal_run_background.output': 'Terminal running in background',
  'browserUse.action.terminal_read.output': 'Terminal read',
  'chat.designToolbox.title': 'Design toolbox',
  'chat.designToolbox.tooltip': 'Open the design toolbox',
  'chat.designToolbox.aria': 'Design toolbox',
  'chat.designToolbox.lucky': 'I\'m feeling lucky',
  'chat.designToolbox.searchPlaceholder': 'Search skills, plugins…',
  'chat.designToolbox.searchAria': 'Search design toolbox',
  'chat.designToolbox.followupSection': 'Follow-up actions',
  'chat.designToolbox.resourcesSection': 'Resources',
  'chat.designToolbox.selected': 'Selected',
  'chat.designToolbox.noResources': 'No resources available',
  ...
  'chat.designToolbox.action.auto-match.title': 'Auto-match design',
  'chat.designToolbox.action.auto-match.badge': 'AI',
  'chat.designToolbox.action.auto-match.description': 'Automatically match design patterns to your project.',
  'chat.designToolbox.action.motion.title': 'Add motion',
  'chat.designToolbox.action.motion.badge': 'Motion',
  'chat.designToolbox.action.motion.description': 'Add animations and transitions.',
  'chat.designToolbox.action.motion-polish.title': 'Motion polish',
  'chat.designToolbox.action.motion-polish.badge': 'Motion',
  'chat.designToolbox.action.motion-polish.description': 'Refine animations for a polished feel.',
  'chat.designToolbox.action.anti-ai-polish.title': 'Anti-AI polish',
  'chat.designToolbox.action.anti-ai-polish.badge': 'Polish',
  'chat.designToolbox.action.anti-ai-polish.description': 'Remove AI-generated look for a hand-crafted feel.',
  'chat.designToolbox.action.visual-polish.title': 'Visual polish',
  'chat.designToolbox.action.visual-polish.badge': 'Polish',
  'chat.designToolbox.action.visual-polish.description': 'Refine spacing, typography, and visual consistency.',
  'chat.designToolbox.action.image-gen.title': 'Generate image',
  'chat.designToolbox.action.image-gen.badge': 'Image',
  'chat.designToolbox.action.image-gen.description': 'Generate images from text descriptions.',
  'chat.designToolbox.action.video-gen.title': 'Generate video',
  'chat.designToolbox.action.video-gen.badge': 'Video',
  'chat.designToolbox.action.video-gen.description': 'Generate video from images or text.',
  ...
  'chat.designToolbox.prompt.contextGeneric': 'The user wants to apply a design action.',
  'chat.designToolbox.prompt.contextSpecific': 'The user selected: {name}',
  'chat.designToolbox.prompt.preserveDraft': 'Preserve the current draft state.',
  'chat.designToolbox.prompt.selectedSkill': 'Selected skill: {name}',
  'chat.designToolbox.prompt.noSkill': 'No skill selected.',
  'chat.designToolbox.prompt.autoMatchIntro': 'Auto-match the design to the current context.',
  'chat.designToolbox.prompt.autoMatchStep1': 'Analyze the current design context.',
  'chat.designToolbox.prompt.autoMatchStep2': 'Identify matching patterns.',
  'chat.designToolbox.prompt.autoMatchStep3': 'Apply the best match.',
  'chat.designToolbox.prompt.autoMatchStep4': 'Verify the result.',
  'chat.designToolbox.prompt.motion': 'Add motion to the selected element.',
  'chat.designToolbox.prompt.motionPolish': 'Polish existing motion and transitions.',
  'chat.designToolbox.prompt.antiAiPolish': 'Remove AI-generated artifacts for a natural look.',
  'chat.designToolbox.prompt.visualPolish': 'Polish visual consistency and spacing.',
  'chat.designToolbox.prompt.imageGen': 'Generate an image from the description.',
  'chat.designToolbox.prompt.videoGen': 'Generate a video from the input.',
  'chat.designToolbox.prompt.useSkill': 'Use the {name} skill.',
  'chat.designToolbox.prompt.skillInstruction': 'Follow the skill instructions precisely.',
  'chat.designToolbox.prompt.selectedResource': 'Selected resource: {name}',
  'chat.designToolbox.prompt.resourceDescription': 'Resource: {description}',
  'chat.designToolbox.prompt.pluginResource': 'Plugin resource: {name}',
  'chat.designToolbox.prompt.mcpResource': 'MCP resource: {name}',
  'chat.designToolbox.prompt.mcpTemplateResource': 'MCP template: {name}',
  'chat.designToolbox.prompt.connectorResource': 'Connector: {name}',
  'chat.designToolbox.prompt.fileResource': 'File: {name}',
  'chat.designToolbox.prompt.resourceIndex': 'Resource #{index}',
  'chat.designToolbox.prompt.searchableSkills': 'Available skills: {skills}',
  'chat.designToolbox.prompt.searchablePlugins': 'Available plugins: {plugins}',
  'chat.designToolbox.prompt.availableMcp': 'Available MCP servers: {servers}',
  'chat.designToolbox.prompt.connectedConnectors': 'Connected connectors: {connectors}',
  'chat.designToolbox.prompt.referenceDesignFiles': 'Reference files: {files}',
  'chat.designToolbox.prompt.mcpTemplateName': 'MCP template: {name}',
  'chat.designToolbox.prompt.processRule': 'Process each item according to its type.',
  'chat.designToolbox.prompt.moreSuffix': 'and {count} more',
  'chat.designToolbox.prompt.compactLine': '{name}: {description}',
  'chat.mentionTabTabs': 'Tabs',
  'chat.mentionSectionTabs': 'Sections',
  'chat.queuedReorder': 'Reorder queued',
  'assistant.copyMarkdown': 'Copy response markdown',
  'assistant.forkConversation': 'Fork conversation',
  ...
  'nextStep.chipJoiner': 'Joiner',
  'nextStep.chipPolishVisual': 'Polish visual',
  'nextStep.chipBrand': 'Brand',
  'nextStep.chipConcise': 'Concise',
  'nextStep.chipSecondVersion': 'Second version',
  'assistant.thought': 'Thinking',
  'assistant.thoughtFor': 'Thinking for {duration}',
  'assistant.possiblePromptInjection': 'Possible prompt injection detected',
  'assistant.statusPreparing': 'Preparing…',
  'questions.tabLabel': 'Questions',
  'questions.banner': 'Answer a few questions to continue.',
  ...
  'questions.autoSkipHint': 'Auto-skip after {seconds}s',
  // END LOCAL I18N KEY BACKFILL
  'chat.connectionDropped': 'chat.connectionDropped',
  'chat.resumeRunCta': 'chat.resumeRunCta',
  'homeWorkingDir.applyFailed': 'homeWorkingDir.applyFailed',
  'homeWorkingDir.clear': 'homeWorkingDir.clear',
  'homeWorkingDir.hint': 'homeWorkingDir.hint',
  'homeWorkingDir.missing': 'homeWorkingDir.missing',
  'homeWorkingDir.pick': 'homeWorkingDir.pick',
  'homeWorkingDir.recent': 'homeWorkingDir.recent',
  'homeWorkingDir.recentEmpty': 'homeWorkingDir.recentEmpty',
  'homeWorkingDir.replace': 'homeWorkingDir.replace',
  'homeWorkingDir.trigger': 'homeWorkingDir.trigger',
  'nextStep.contribute': 'nextStep.contribute',
  'nextStep.download': 'nextStep.download',
  'nextStep.more': 'nextStep.more',
  'pluginsHome.subfacet.app-prototypes': 'pluginsHome.subfacet.app-prototypes',
  'pluginsHome.subfacet.avatar-portrait': 'pluginsHome.subfacet.avatar-portrait',
  'pluginsHome.subfacet.brand-design': 'pluginsHome.subfacet.brand-design',
  'pluginsHome.subfacet.brand-visuals': 'pluginsHome.subfacet.brand-visuals',
  'pluginsHome.subfacet.business-dashboards': 'pluginsHome.subfacet.business-dashboards',
  'pluginsHome.subfacet.cinematic-story': 'pluginsHome.subfacet.cinematic-story',
  'pluginsHome.subfacet.course-training': 'pluginsHome.subfacet.course-training',
  'pluginsHome.subfacet.creative-decks': 'pluginsHome.subfacet.creative-decks',
  'pluginsHome.subfacet.data-explainers': 'pluginsHome.subfacet.data-explainers',
  'pluginsHome.subfacet.developer-tools': 'pluginsHome.subfacet.developer-tools',
  'pluginsHome.subfacet.docs-reports': 'pluginsHome.subfacet.docs-reports',
  'pluginsHome.subfacet.engineering-talks': 'pluginsHome.subfacet.engineering-talks',
  'pluginsHome.subfacet.illustration-style': 'pluginsHome.subfacet.illustration-style',
  'pluginsHome.subfacet.landing-marketing': 'pluginsHome.subfacet.landing-marketing',
  'pluginsHome.subfacet.marketing-product': 'pluginsHome.subfacet.marketing-product',
  'pluginsHome.subfacet.motion-effects': 'pluginsHome.subfacet.motion-effects',
  'pluginsHome.subfacet.pitch-business': 'pluginsHome.subfacet.pitch-business',
  'pluginsHome.subfacet.product-sales': 'pluginsHome.subfacet.product-sales',
  'pluginsHome.subfacet.reports-briefings': 'pluginsHome.subfacet.reports-briefings',
  'pluginsHome.subfacet.social-content': 'pluginsHome.subfacet.social-content',
  'pluginsHome.subfacet.social-short-form': 'pluginsHome.subfacet.social-short-form',
  'pluginsHome.subfacet.storyboards-motion-refs': 'pluginsHome.subfacet.storyboards-motion-refs',
  'pluginsHome.subfacet.ui-product-mockups': 'pluginsHome.subfacet.ui-product-mockups',
  'preview.usePlugin': 'preview.usePlugin',
  'updater.installRestart': 'updater.installRestart',
  'updater.installingRestart': 'updater.installingRestart',
  'updater.payloadReadyGeneric': 'updater.payloadReadyGeneric',
  'updater.payloadReadyVersion': 'updater.payloadReadyVersion',
  'preview.replicateContent': 'preview.replicateContent',
  'preview.replicateContentDesc': 'preview.replicateContentDesc',
  'preview.usePluginOnly': 'preview.usePluginOnly',
  'preview.usePluginOnlyDesc': 'preview.usePluginOnlyDesc',
  ...
  'settings.onboardingCloudBody': "Finish the initial setup to start designing — choose your runtime and language below.",
  'settings.onboardingCloudContinue': "Continue",
  'settings.onboardingCloudOr': 'or',
  'settings.onboardingCloudRights': 'All rights reserved.',
  'settings.onboardingCloudSignIn': "Get started",
  'settings.onboardingCloudTitle': "Set up Open Design",
