...
export const fa: Dict = {
  ...
  'settings.accountHint': "مدیریت حساب 云档期",
  'settings.accountAbout': "حساب",
  'settings.accountAboutHint': "نسخه و خروج",
  'settings.accountSignOutTitle': "خروج از 云档期",
  'settings.accountSignOutHint': "اعتبار ذخیره‌شده محلی را پاک کرده و برنامه را برای مجوزدهی مجدد راه‌اندازی کنید",
  'settings.accountSignOut': "خروج",
  ...
  'workspace.closeTabsToRight': 'بستن تب‌های سمت راست',
  'workspace.closeOtherTabs': 'بستن سایر تب‌ها',
  'workspace.closeAllTabs': 'بستن همه تب‌ها',
  ...
  'designFiles.deleteFolderConfirm': 'پوشه "{name}" و همه محتوای آن حذف شود؟',
  'designFiles.folderCreated': 'پوشه "{name}" ساخته شد',
  'designFiles.folderDeleted': 'پوشه "{name}" حذف شد',
  'designFiles.filesMoved': '{n} مورد به {dest} منتقل شد',
  'designFiles.newSubfolder': 'پوشهٔ زیرمجموعهٔ جدید',
  'designFiles.untitledFolderName': 'پوشهٔ بدون نام',
  'designFiles.folderNameEmpty': 'نام پوشه نمی‌تواند خالی باشد.',
  'designFiles.addToFolder': 'افزودن به پوشه',
  'designFiles.addToFolderEmpty': 'هنوز پوشه‌ای وجود ندارد',
  'designFiles.selectFolder': 'انتخاب پوشه',
  ...
  'designFiles.sectionStylesheets': 'استایل‌شیت‌ها',
  'designFiles.sectionDocuments': 'اسناد',
  'designFiles.kindStylesheet': 'استایل‌شیت',
  'designFiles.modifiedExt': 'تغییر یافته {time} · {size} · {ext}',
  'designFiles.usefulInfoLabel': 'اطلاعات مفید',
  'designFiles.usefulInfoTip': 'برای باز کردن فایل در یک تب کامل، دوبار کلیک کنید.',
  'designFiles.batchSelect': 'انتخاب دسته‌ای',
  'designFiles.expandAll': "گسترش همه",
  'designFiles.collapseAll': "جمع کردن همه",
...
'designFiles.copyFailed': "کپی ناموفق بود، دوباره تلاش کنید",
  ...
  'fileViewer.exportImageScaleLabel': 'مقیاس',
  'fileViewer.exportImageSaving': 'در حال ذخیره تصویر…',
  'fileViewer.exportImageCapturing': 'در حال تولید پیش‌نمایش…',
