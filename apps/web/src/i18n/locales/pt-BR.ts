...
export const ptBR: Dict = {
  ...
  'settings.accountHint': "Gerencie sua conta 云档期",
  'settings.accountAbout': "Conta",
  'settings.accountAboutHint': "Versão e sair",
  'settings.accountSignOutTitle': "Sair da 云档期",
  'settings.accountSignOutHint': "Limpe a credencial armazenada localmente e reinicie o aplicativo para reautorizar",
  'settings.accountSignOut': "Sair",
  ...
  'workspace.closeTabsToRight': 'Fechar abas à direita',
  'workspace.closeOtherTabs': 'Fechar outras abas',
  'workspace.closeAllTabs': 'Fechar todas as abas',
  ...
  'designFiles.moveTitle': 'Mover para pasta',
  ...
  'designFiles.filesMoved': '{n} movidos para {dest}',
  'designFiles.newSubfolder': 'Nova subpasta',
  'designFiles.untitledFolderName': 'Pasta sem nome',
  'designFiles.folderNameEmpty': 'O nome da pasta não pode estar vazio.',
  'designFiles.addToFolder': 'Adicionar à pasta',
  'designFiles.addToFolderEmpty': 'Nenhuma pasta ainda',
  'designFiles.selectFolder': 'Selecionar pasta',
  ...
  'designFiles.usefulInfoLabel': 'Informação útil',
  'designFiles.usefulInfoTip': 'Dê dois cliques em um arquivo para abri-lo em uma aba completa.',
  'designFiles.batchSelect': 'Seleção em lote',
...
'designFiles.copyFailed': "Falha ao copiar, tente novamente",
  ...
  'fileViewer.exportImageCapturing': 'Gerando prévia…',
